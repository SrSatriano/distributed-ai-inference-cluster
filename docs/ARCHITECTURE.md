# Arquitetura — Gerenciador de cluster de inferência de IA

> Versão do documento: **1.0.0** · Última revisão: **2026-03-26**

## 1. Visão geral

Roteamento least-queue, health checks e HPA baseado em fila.
...
|------------|------------------|
| Roteamento | Roteamento least-queue com health check |
| Manifests | Manifests Kubernetes e HPA |
| Bootstrap | Bootstrap de workers documentado |
| Dashboard | Dashboard Grafana |
| Roteamento | Roteamento sensível a temperatura GPU (opcional) |
